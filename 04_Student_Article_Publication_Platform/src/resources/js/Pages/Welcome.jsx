...
export default function Welcome({ auth, recentArticles = [], landingStats = {} }) {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 sm:py-4">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <motion.div
                            ...
                            className="text-4xl font-black tracking-normal font-serif cursor-pointer group sm:text-5xl lg:text-6xl"
                        ...
                        {!auth.user && !showAuth && (
                            ...
                            >
                                <motion.button
                                    ...
                                    className="px-5 py-2 font-serif text-sm uppercase tracking-wider transition-all duration-300 relative overflow-hidden group"
                                    style={{
                                        backgroundColor: colors.primary,
                                        color: colors.background
                                    }}
                                ...
                                <motion.button
                                    ...
                                    className="px-5 py-2 border-2 font-serif text-sm uppercase tracking-wider transition-all duration-300 relative overflow-hidden group"
                                    style={{
                    ...
                    >
                        <ul className="flex gap-4 overflow-x-auto pb-1 text-xs font-mono uppercase tracking-wider sm:gap-6">
                            {[
                                { id: 'home', label: 'Home' },
            ...
            <div id="home" className="relative pt-64 sm:pt-52">
                <motion.div
                    ref={targetRef}
            ...
            >
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        <motion.div
                            className="font-serif text-5xl font-black tracking-normal mb-2 cursor-pointer sm:text-7xl"
                            style={{ color: colors.text }}
                            whileHover={{ scale: 1.02 }}
                            onClick={() => scrollToSection('home')}
                        >
