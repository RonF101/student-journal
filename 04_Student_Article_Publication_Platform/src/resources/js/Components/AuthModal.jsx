        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <motion.div
                    ...
                    className="relative max-h-[calc(100vh-2rem)] w-full max-w-sm overflow-y-auto"
                    role="dialog"
                    aria-modal="true"
                        ...
                        {!showForgotPassword && mode !== 'reset' && mode !== 'verify' ? (
                            ...
                            <>
                                ...
                                <div className="px-6 pt-6 pb-2 text-center border-b" style={{ borderColor: colors.border }}>
                                    <div id="auth-modal-title" className="font-serif text-3xl font-black tracking-tight" style={{ color: colors.text }}>
                                        THE FYI
                                    </div>
                                    ...
                                    >
                                        {mode === 'login' ? (
                                            ...
                                            <form onSubmit={handleLogin} className="px-6 py-4 space-y-4">
                                                <div>
                                                    <label htmlFor="login-email" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        EMAIL ADDRESS
                                                    </label>
                                                    <input
                                                        id="login-email"
                                                ...
                                                <div>
                                                    <label htmlFor="login-password" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        PASSWORD
                                                    </label>
                                                    <input
                                                        id="login-password"
                                            ...
                                            <form onSubmit={handleRegister} className="px-6 py-4 space-y-4">
                                                <div>
                                                    <label htmlFor="register-name" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        FULL NAME
                                                    </label>
                                                    <input
                                                        id="register-name"
                                                ...
                                                <div>
                                                    <label htmlFor="register-email" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        EMAIL ADDRESS
                                                    </label>
                                                    <input
                                                        id="register-email"
                                                ...
                                                <div>
                                                    <label htmlFor="register-password" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        PASSWORD
                                                    </label>
                                                    <input
                                                ...
                                                <div>
                                                    <label htmlFor="register-password-confirmation" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                        CONFIRM PASSWORD
                                                    </label>
                                                    <input
                            ...
                            <>
                                ...
                                <div className="px-6 pt-10 pb-6">
                                    <form onSubmit={handleResetPassword} className="space-y-4">
                                        ...
                                        <div>
                                            <label htmlFor="reset-email" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                EMAIL ADDRESS
                                            </label>
                                            <input
                                                id="reset-email"
                                        ...
                                        <div>
                                            <label htmlFor="reset-password" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                NEW PASSWORD
                                            </label>
                                            <input
                                                id="reset-password"
                                        ...
                                        <div>
                                            <label htmlFor="reset-password-confirmation" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                CONFIRM PASSWORD
                                            </label>
                                            <input
                                ...
                                <div className="px-6 pt-10 pb-6">
                                    {!resetSent ? (
                                        <form onSubmit={handleForgotPassword} className="space-y-4">
                                            ...
                                            <div>
                                                <label htmlFor="forgot-password-email" className="block font-mono text-[10px] uppercase tracking-wider mb-1" style={{ color: colors.textSecondary }}>
                                                    EMAIL ADDRESS
                                                </label>
                                                <input
